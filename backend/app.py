...
print(result)
data = {"email": "akashuhulekal@gmail.com", "password": "1234567890", "user_id": 12}
result = databases.create_document(
    "646ef96e9f67246e693d", "646efcfd07349b8a4ffd", "unique()", data
)
print(result)
...
def explore():
    return get_requests.explore(
        databases, databaseID, tagsCollectionID, postsCollectionID, userCollectionID
    )
...
def addpost():
    data = request.json
    return post_requests.addpost(
        data, databases, databaseID, postsCollectionID, tagsCollectionID
    )
...
def updatepost():
    data = request.json
    return post_requests.updatepost(
        data["post_id"], databases, databaseID, postsCollectionID
    )
...
def deletepost():
    data = request.json
    return post_requests.deletepost(
        data["post_id"], databases, databaseID, postsCollectionID
    )
...
def follower():
    data = request.json
    return get_requests.followers(data, databases, databaseID, followCollectionID)


@app.route("/getfollowing", methods=["GET", "POST"])
def following():
    data = request.json
    return get_requests.following(data, databases, databaseID, followCollectionID)
...
def ban():
    data = request.json
    return post_requests.banned_ip(data, databases, databaseID, followCollectionID)
...
def follow():
    data = request.json
    return post_requests.follow(data, databases, databaseID, userCollectionID)


@app.route("/unfollow", methods=["POST"])
def unfollow():
    data = request.json
    return post_requests.unfollow(data, databases, databaseID, userCollectionID)


@app.route("/following_list", methods=["GET"])
def following_list():
    data = request.json
    return get_requests.following_list(data, databases, databaseID, userCollectionID)


@app.route("/followers_list", methods=["GET"])
def followers_list():
    data = request.json
    return get_requests.followers_list(data, databases, databaseID, userCollectionID)
...
def like_comment():
    ...
    return post_requests.likecomment(data, databases, databaseID, commentCollectionID)
...
def unlike_comment():
    ...
    return post_requests.removelikecomment(
        data, databases, databaseID, commentCollectionID
    )
...
def capture_payment():
    data = request.json
    return post_requests.capture_payment(
        data, databases, databaseID, razorpayCollectionID
    )
...
def msg():
    data = request.json
    return post_requests.msgfn(data,handle_message,userCollectionID)
